  ...
  const contacts = [
    {
      ...
      text: '32/2, Zeki Velidi St., Ufa, Republic of Bashkortostan, Russian Federation, 450076',
      icon: (
    ...
    },
    {
      type: 'production',
      title: 'Production',
      text: '16/2, Blagovarskaya St., Ufa, Republic of Bashkortostan, Russian Federation, 450019',
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      type: 'phone',
      title: 'For inquiries regarding job vacancies, please call',
    ...
    {
      type: 'phone-export',
      title: 'For export inquiries, please call',
      text: '1231',
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56-.35-.12-.74-.03-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99z" />
        ...
        <header className={Styles.hero}>
          ...
          <div className={Styles.heroGrid}>
            ...
            <div className={Styles.heroDescription}>
              ...
              <p>
                Get in touch with us in any convenient way.
                We will answer your questions, discuss your
        ...
        <div className={Styles.content}>
          ...
          >
            ...
            <div className={Styles.mapContainer}>
              <iframe
                src="https://yandex.ru/map-widget/v1/?um=constructor%3A7e310988bcfd232d57415d059b582e872e6f9b30a42d2aad2a15aa82885ad21f&amp;source=constructor"
                frameBorder="0"
                allowFullScreen
                aria-hidden="false"
                tabIndex={0}
