      ...
      <div className={Styles.page}>
        ...
        <section className={`${Styles.hero} ${Styles.reveal}`}>
          <div className={Styles.heroText}>
            <h1>
              <span>ERVIP</span> Vortex flowmeter
            </h1>

            <p>
              High-precision industrial intrument for measuring liquid and gas flow rate in the "Sputnik" automated group metering skids.
            </p>
        ...
        <section className={`${Styles.features} ${Styles.reveal}`}>
          ...
          <div className={Styles.featuresGrid}>
            {[
              ...
              ["Reliability", "Easy maintenance and industrial grade high reliability"],
              ["Longevity", "Service life is 12 year."],
              ["Stability", "High tolerance to pollution and stable operation in the complicated conditions."],
              ["Recalibration interval", "Up to 4 years without recalibration"],
              ["Flexibility", "Flexible measurement range setting"],              
            ].map(([title, text], i) => (
        ...
        <section className={`${Styles.tech} ${Styles.reveal}`}>
          ...
          <div className={Styles.techText}>
            ...
            <p>
              The flow measurement is based on the formation of a Kármán vortex street behind an obstacle in the flow of the medium.
            </p>

            <p>
              The vortex formation frequency is proportional to the flow velocity, which allows accurate determination of liquid and gas flow rates.
            </p>

            <p>
              A piezoelectric crystal inside the obstacle generates electrical impulses that are measured by the electronics of the vortex flowmeter.
            </p>
